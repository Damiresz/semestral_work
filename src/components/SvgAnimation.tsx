...
/**
 * SvgAnimation component that demonstrates SVG manipulation
 * Includes color change and rotation animations
 */
export default function SvgAnimation() {
  // State for SVG color and rotation
  ...
  return (
    ...
    >
      ...
      <svg
        ...
        className="mb-4"
      >
        {/* Star shape using polygon points */}
        <polygon points="12,2 15,9 22,9.5 17,14.5 18.5,22 12,18 5.5,22 7,14.5 2,9.5 9,9" />
      </svg>
      {/* Button to trigger color change and rotation */}
      <button
